            ...
            */
            ...
            this.pcbObj = function() { 
                return {
                    ...
                    supportedFiles: [
                        {type: 'eagle', ext:".brd", signature: new RegExp('<!DOCTYPE eagle SYSTEM ' + String.fromCharCode(34) + 'eagle.dtd' + String.fromCharCode(34) + '>[' + String.fromCharCode(92) + 's' + String.fromCharCode(92) + 'S]*<board>', "im")},
