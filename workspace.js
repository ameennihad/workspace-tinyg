            ...
            */
            ...
            this.pcbObj = function() { 
                return {
                    ...
                    supportedFiles: [
                        {type: 'eagle', ext:".brd", signature: new RegExp("<!DOCTYPE eagle SYSTEM \"eagle.dtd\">[\\s\\S]*<board>", "im")},
                        {type: 'kiCad', ext:".kicad_pcb", signature: new RegExp("\\(kicad_pcb \\(version \\d+\\) \\(host pcbnew", "i")}
					],
